...
search.addEventListener('click', () => {
    ...
    const APIKey = 'cd51c2ed8e48b04b88812c6286516e9c';
    ...
    fetch('https://api.openweathermap.org/data/3.0/weather?q=${city}&units=metric&appid=${APIKey}')
         ...
         .then(json => {
            ...
            const description = document.querySelector('.weather-box .discrption');
           ...
           wind.innerHTML = `${parseInt(json.main.humidity)}km/h`;
